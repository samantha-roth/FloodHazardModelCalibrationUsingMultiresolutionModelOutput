...
#second chain
output <- mh.alg(init = init_vals, n.sample = 3e5-201000)
...
if(nug==TRUE){
  ...
  #2nd 99k
  save(res,file="vat_rw_MH_homMR_sqexp_nug2.RData")
  save(proposals,file="vatprops_rw_MH_homMR_sqexp_nug2.RData")
  save(ptFinal,file="vat_time_rw_MH_homMR_sqexp_nug2.RData")
...
#(nrow(res)-1)/(ess(res[,2],imse=FALSE)/4000)
