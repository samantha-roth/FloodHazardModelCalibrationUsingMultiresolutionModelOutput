...
if(dir.exists(paste("/storage/work/svr5482/FloodingModelCalibrationProject/multires/spatial/changPC2014/10m50m/outputData/nCh_RWE/100e400c/downscale/cal/",nPCs,"PCs/.25/3cm/chain3",sep=""))==F)
{dir.create(paste("/storage/work/svr5482/FloodingModelCalibrationProject/multires/spatial/changPC2014/10m50m/outputData/nCh_RWE/100e400c/downscale/cal/",nPCs,"PCs/.25/3cm/chain3",sep=""))}
...
if(nug==TRUE){
  ...
  #setwd(paste("/storage/work/svr5482/FloodingModelCalibrationProject/multires/spatial/changPC2014/10m50m/outputData/nCh_RWE/100e400c/downscale/cal/",nPCs,"PCs/.25/3cm/chain3",sep=""))
  #load("vat_rw_MH_homMRnug.RData")
  #load("vatprops_rw_MH_homMRnug.RData")
  #load("vat_time_rw_MH_homMRnug.RData")
