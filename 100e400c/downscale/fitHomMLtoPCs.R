...
##################################with nugget###################################
#homMLExpnug<- stan_model("hom-MLExp-nugget.stan")
################################################################################
...
foreach(k = 1:nPCs)%dopar%{
  ...
  find.mode <- function(x){
    ...
    #matern
    #rstan::optimizing(homMLMat, data = ml.data, verbose = F, as_vector = F)
  ...
  #matern
  #save(pars,file=paste("/storage/work/svr5482/FloodingModelCalibrationProject/multires/spatial/changPC2014/10m50m/outputData/nCh_RWE/100e400c/downscale/",nPCs,"PCs/pars.homMLMat.PC",k,".RData",sep=""))
  #save(time,file=paste("/storage/work/svr5482/FloodingModelCalibrationProject/multires/spatial/changPC2014/10m50m/outputData/nCh_RWE/100e400c/downscale/",nPCs,"PCs/time.homMLMat.PC",k,".RData",sep=""))
